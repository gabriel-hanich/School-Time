...
function setDeteleteBtnListeners(){ // Function that sets all the delete buttons on screen an event listener
...
function deleteNote(event){ // Deletes the note from the list and local storage
